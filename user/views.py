...
class UserRegistrationView(APIView):
    ...
    def post(self, request):
        ...
        try:
            if int(data["age"]) < 15:
                return Response(
                    {"error": "Your too young !"}, status=status.HTTP_401_UNAUTHORIZED
                )
...
class ContributorView(APIView):
    ...
    def get(self, request, project_id):
        try:
            ...
            return Response(
                {"message": "You are now contributor of this project !"},
                status=status.HTTP_201_CREATED,
            )
        except Exception as e:
            return Response(
    ...
    def delete(self, request, project_id):
        try:
            ...
            if project in contributor.projects.all():
                ...
                return Response(
                    {"message": "You are no longer a contributor of this project."},
